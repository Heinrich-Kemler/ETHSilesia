 ...
 * Replace this SVG with a real animated mascot later.
 */
export default function SkarbnikMascot({
  ...
  return (
    ...
    >
      ...
      <rect x="38" y="36" width="44" height="6" rx="2" fill="#38BDF8" opacity="0.8" />
      ...
      <line x1="53" y1="42" x2="53" y2="78" stroke="#38BDF8" strokeWidth="0.8" opacity="0.4" />
      <line x1="67" y1="42" x2="67" y2="78" stroke="#38BDF8" strokeWidth="0.8" opacity="0.4" />
      ...
      <rect x="38" y="78" width="44" height="5" rx="2" fill="#C9A84C" opacity="0.7" />
      <path d="M56 83 L60 90 L64 83" fill="#C9A84C" opacity="0.5" />
      ...
      <circle cx="35" cy="30" r="1" fill="#C9A84C" opacity="0.6" />
      <circle cx="85" cy="25" r="0.8" fill="#38BDF8" opacity="0.5" />
      <circle cx="30" cy="65" r="0.7" fill="#D946A8" opacity="0.4" />
      <circle cx="90" cy="60" r="1" fill="#C9A84C" opacity="0.5" />
      <circle cx="25" cy="48" r="0.5" fill="#38BDF8" opacity="0.3" />
      <circle cx="95" cy="45" r="0.6" fill="#D946A8" opacity="0.3" />
    </svg>
  );
}
